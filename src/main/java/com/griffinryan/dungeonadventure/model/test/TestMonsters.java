...
final public class TestMonsters {
    ...
    void testDefaultOgre() throws SQLException {
        final var theOgre = MonstersFactory.spawn("Ogre", myMonsterDummyName);
    ...
    void testDefaultGremlin() throws SQLException {
        final var theGremlin = MonstersFactory.spawn("Gremlin", myMonsterDummyName);
        // check to see if the Monster return by the MonstersFactory is Gremlin
    ...
    void testDefaultSkeleton() throws SQLException {
        final var theSkeleton = MonstersFactory.spawn("Skeleton", myMonsterDummyName);
        // check to see if the Monster return by the MonstersFactory is Gremlin
